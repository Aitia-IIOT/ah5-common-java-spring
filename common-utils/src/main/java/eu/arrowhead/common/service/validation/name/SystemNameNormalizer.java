...
public class SystemNameNormalizer {
	...
	public String normalize(final String name) {
		logger.debug("SystemNameNormalizer.normalize started...");
	...
	private String transformName(final String name) {
		logger.debug("SystemNameNormalizer.transformName started...");
		...
		return NormalizationUtils.convertSnakeCaseToPascalCase(result);
	}
}