...
import eu.arrowhead.common.intf.properties.validators.NotEmptySetValidator;
...
public class PropertyValidators {
	...
	private void init() {
		...
		validators.put(PropertyValidatorType.NOT_EMPTY_SET, appContext.getBean(NotEmptySetValidator.class));
